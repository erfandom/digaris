            ...
            <div className="flex flex-wrap text-center justify-center">
              ...
              />
                <h2 className="text-4xl font-medium text-black">
                  Selamat Datang di <span className="text-indigo-600 font-bold">DIGARIS (Digital Arsiparis)</span>
                </h2>
                ...
                <Link href="/login/sp2020">
                  <div className="bg-blue-500 shadow-lg rounded-lg text-center p-8 mt-8">
                      <img
                        ...
                        src="/img/logo/sp.png"
                      />
                      <button className="bg-white mt-4 text-blue-500 active:bg-indigo-600 text-md font-bold uppercase px-3 py-1 rounded 
                      outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
                        SP2020
                      </button>
                  </div>
              ...
              <div className="w-full lg:w-4/12 px-6 text-center">
                <Link href="/login/keuangan">
                  <div className="bg-teal-500 shadow-lg rounded-lg text-center p-8 mt-8">
                      ...
                      />
                      <button className="bg-white mt-4 text-teal-500 active:bg-indigo-600 text-md font-bold uppercase px-3 py-1 rounded 
                      outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
                        Keuangan
                      </button>
                  </div>
